...
Each matrix with Gaussian integer entries is formated as 4 rows.

Each row is formated as 4 Gaussian integers.

Each Gaussian integer is formated as a pair (Integer, Integer).
